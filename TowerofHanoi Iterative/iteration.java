...
import java.io.*;
import java.lang.*;
public class iteration   // iterative hanoi. corners : 0, 1 and 2. Discs 0,1,  .. N-1
{
...
for (i=1; i<= nummoves; i++)
   {
// remembers which corner each disc is on
// initially all are on 0
// 2 is destination
if (i%2==1) {
} }
// odd numbered move - move disc 1
second = locations[1];
                                    // remember where disc 1 moved from
